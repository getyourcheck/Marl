...
train_config = dict(
    ...
    ppo_loss_weight=1.0 * (PROMPT_BATCH_SIZE + PRETRAIN_BATCH_SIZE) / PROMPT_BATCH_SIZE,
    pretrain_loss_weight=0.5 * (PROMPT_BATCH_SIZE + PRETRAIN_BATCH_SIZE) / PRETRAIN_BATCH_SIZE,
    critic_warmup_step=40,  # TODO
    resume_step=resume_step,
    save_interval=40,
    max_train_step=400,
    use_varlen_attn=use_varlen_attn,
    pretrain_criterion=PretrainLoss(label_smoothing=0, loss_type="per_token"),
