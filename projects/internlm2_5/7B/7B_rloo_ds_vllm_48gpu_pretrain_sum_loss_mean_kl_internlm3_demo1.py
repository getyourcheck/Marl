...
from marl.loss import PretrainLoss, RLOOLoss
train_config = dict(
    ...
    policy_criterion=RLOOLoss(cliprange=0.2, loss_type="per_seq"),
)
    ...
    policy=dict(
        ...
        trainer_config=dict(
            ...
            deepspeed_config={
                ...
                'gradient_accumulation_steps': sp_size * (PROMPT_BATCH_SIZE * rloo_k + PRETRAIN_BATCH_SIZE) // POLICY_DP_SIZE // TRAIN_MICRO_BATCH_SIZE,
                'train_batch_size': sp_size * (PROMPT_BATCH_SIZE * rloo_k + PRETRAIN_BATCH_SIZE),
            },
        ),
    ...
    reference=dict(
        ...
        trainer_config=dict(
            ...
            deepspeed_config={
                ...
                'train_micro_batch_size_per_gpu': TRAIN_MICRO_BATCH_SIZE,
                'gradient_accumulation_steps': (PROMPT_BATCH_SIZE * rloo_k + PRETRAIN_BATCH_SIZE) // reference_dp_size // TRAIN_MICRO_BATCH_SIZE,
                'train_batch_size': PROMPT_BATCH_SIZE * rloo_k + PRETRAIN_BATCH_SIZE,
            },
        ),
    ),
    reward=dict(
        ...
        trainer_config=dict(
            ...
            deepspeed_config={
                ...
                'train_micro_batch_size_per_gpu': TRAIN_MICRO_BATCH_SIZE,
                'gradient_accumulation_steps': PROMPT_BATCH_SIZE * rloo_k // reward_dp_size // TRAIN_MICRO_BATCH_SIZE,
                'train_batch_size': PROMPT_BATCH_SIZE * rloo_k,
            },
        ),
    ),
)
...
assert (PROMPT_BATCH_SIZE * rloo_k + PRETRAIN_BATCH_SIZE) % (TRAIN_MICRO_BATCH_SIZE *
                                                    POLICY_DP_SIZE) == 0
