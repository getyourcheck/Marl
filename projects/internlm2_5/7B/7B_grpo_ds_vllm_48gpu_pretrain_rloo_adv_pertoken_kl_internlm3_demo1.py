...
repeater_config = dict(
    ...
    grpo_k=grpo_k,
    use_loo=True,
    kl_reward_penalty="per_token",
    kl_coeff=0.01,
    non_eos_penalty=False,
)

from marl.loss import PretrainLoss, GRPOPolicyLoss
train_config = dict(
    ...
    policy_criterion=GRPOPolicyLoss(cliprange=0.2, 
                                    kl_coef=0.01,
                                    kl_penalty_loss=False,
                                    sampling_group_size=grpo_k,
                                    loss_type="per_token"),
)
...
prompt_dataset_config = dict(
    ...
    message_datasets=[
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/Anthropic_hh-rlhf_helpful-base-train-deduplicate.json::0.25",
        ...
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/lmsys-chat-english-chat-format-100char-1t.json::0.01",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/airoboros_reward.json::1.0",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/Anthropic_hh-rlhf_harmless-base-train-deduplicate.json::0.1",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/out_instinwild_cn_origin_18_26-rd.json::0.5",
        ...
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/zhihu_177k_outline_to_artical-with-sys.json::0.003", # 0.1*0.8
        ...
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/wangrui6_Zhihu-KOL-train-deduplicate.json::0.01",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/zijianwenti-2k_0801-train.json::1.0",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/shezheng_52230_20230905_prompts-train-rd.json::0.1[RM_PROMPT]:cn-safety",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/yuqing_5817_20230831_prompts-train-rd.json::0.1[RM_PROMPT]:cn-safety",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/shezheng_adv_7549_20230913-train-rd.json::0.1",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/yuqing_adv_5817_20230913-train-rd.json::0.1",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/lingdaoren_adv_4963_20230913-train-rd.json::0.1",
        ...
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/math_shepherd_ppo_prompt_augmented.json::0.5",
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/40k_sampled_prompt_for_ppo.json::0.5",
        ...
        "/fs-computility/llm/shared/lishuaibin/datasets/internlm2_5_baseline/gongwuyuan_logic_prompt_for_ppo.json::0.5",
        ...
        # new added
        "/fs-computility/llm/shared/lvchengqi/ppo_prompt_datasets/puyu_webchat_single_round_data_less_than_3000_for_ppo.jsonl::1.0",
        "/fs-computility/llm/shared/lvchengqi/ppo_prompt_datasets/subjective_prompts_evolve.jsonl::1.0",
        "/fs-computility/llm/shared/lvchengqi/ppo_prompt_datasets/lmsys-arena-human-preference-55k_single_round_for_ppo.jsonl::1.0[RM_PROMPT]:lmsys_arena",
        "/fs-computility/llm/shared/lvchengqi/ppo_prompt_datasets/opencompass_arena_non_tie_preference_data_for_ppo.jsonl::1.0",
    ])
    ...
    policy=dict(
        ...
        trainer_config=dict(
            ...
            deepspeed_config={
                ...
                'gradient_accumulation_steps': sp_size * (PROMPT_BATCH_SIZE * grpo_k + PRETRAIN_BATCH_SIZE) // POLICY_DP_SIZE // TRAIN_MICRO_BATCH_SIZE,
                'train_batch_size': sp_size * (PROMPT_BATCH_SIZE * grpo_k  + PRETRAIN_BATCH_SIZE),
            },
        ),
    ...
    reference=dict(
        ...
        trainer_config=dict(
            ...
            deepspeed_config={
                ...
                'train_micro_batch_size_per_gpu': TRAIN_MICRO_BATCH_SIZE,
                'gradient_accumulation_steps': (PROMPT_BATCH_SIZE * grpo_k  + PRETRAIN_BATCH_SIZE) // reference_dp_size // TRAIN_MICRO_BATCH_SIZE,
                'train_batch_size': PROMPT_BATCH_SIZE * grpo_k  + PRETRAIN_BATCH_SIZE,
            },
        ),
    ),
    reward=dict(
        ...
        trainer_config=dict(
            ...
            deepspeed_config={
                ...
                'train_micro_batch_size_per_gpu': TRAIN_MICRO_BATCH_SIZE,
                'gradient_accumulation_steps': PROMPT_BATCH_SIZE * grpo_k  // reward_dp_size // TRAIN_MICRO_BATCH_SIZE,
                'train_batch_size': PROMPT_BATCH_SIZE * grpo_k ,
            },
        ),
    ),
)
...
assert (PROMPT_BATCH_SIZE * grpo_k  + PRETRAIN_BATCH_SIZE) % (TRAIN_MICRO_BATCH_SIZE *
                                                    POLICY_DP_SIZE) == 0
