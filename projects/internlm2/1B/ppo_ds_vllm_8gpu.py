...
model_configs = dict(
    policy=dict(
        model_path='/fs-computility/llm/shared/marl/models/internlm2/1.8B/hf/internlm2-chat-1_8b-sft/',
        model_type='policy',
        trainer_config=dict(
...
prompt_dataset_config = dict(
    ...
    message_datasets=[
        './demo_datas/prompt_data.json::0.01[SYS_PROMPT]:summarization',  # noqa: E501
