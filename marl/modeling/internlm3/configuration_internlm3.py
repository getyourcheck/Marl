...
InternLM3_PRETRAINED_CONFIG_ARCHIVE_MAP = {}
...
class InternLM3Config(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the InternLM3 model. Defines the number of different tokens that can be represented
            by the `inputs_ids` passed when calling [`InternLM3Model`]
        hidden_size (`int`, *optional*, defaults to 4096):
            Dimension of the hidden representations.
        intermediate_size (`int`, *optional*, defaults to 11008):
            Dimension of the MLP representations.
        num_self_decoder_layers (`int`, *optional*, defaults to 24):
            Number of self decoder layers in InternLM3-Middle model.
        num_cross_decoder_layers (`int`, *optional*, defaults to 24):
            Number of cross decoder layers in InternLM3-Middle model.
        ...
        max_position_embeddings (`int`, *optional*, defaults to 2048):
            The maximum sequence length that this model might ever be used with. InternLM3 supports up to 32768 tokens.
    ...
    def __init__(  # pylint: disable=W0102
        ...
        num_self_decoder_layers=24,
        num_cross_decoder_layers=24,
